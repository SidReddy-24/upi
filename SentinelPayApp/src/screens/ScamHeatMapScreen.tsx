...
const styles = StyleSheet.create({
  ...
  center: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#FAF7F0' },
  header: { marginBottom: 16 },
  title: { fontSize: 22, fontWeight: '800', color: '#1A1A2E', marginBottom: 4 },
  subtitle: { fontSize: 13, color: '#64748b' },
  waveBanner: { backgroundColor: '#FEE2E2', borderLeftWidth: 4, borderLeftColor: '#E63946', padding: 14, borderRadius: 12, marginBottom: 16 },
  waveTitle: { fontSize: 13, fontWeight: '800', color: '#991B1B', marginBottom: 4 },
  waveDesc: { fontSize: 12, color: '#7F1D1D', lineHeight: 16 },
  mapCard: { backgroundColor: '#1A1A2E', borderRadius: 20, overflow: 'hidden', marginBottom: 16, borderWidth: 1, borderColor: '#E8C4B8' },
  mapCardHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 12, backgroundColor: '#1A1A2E' },
  mapCardTitle: { color: '#FAF7F0', fontSize: 13, fontWeight: '700' },
  webViewWrapper: { width: '100%', height: MAP_HEIGHT, overflow: 'hidden' },
  webView: { width: '100%', height: MAP_HEIGHT, backgroundColor: '#1A1A2E' },
  intelCard: { backgroundColor: '#E8C4B8', borderRadius: 18, padding: 16, marginBottom: 20 },
  intelHeader: { fontSize: 15, fontWeight: '800', color: '#1A1A2E', marginBottom: 10 },
  intelRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 6 },
  intelLabel: { fontSize: 13, color: '#1A1A2E', fontWeight: '500' },
  intelVal: { fontSize: 13, fontWeight: '700', color: '#1A1A2E' },
  sectionTitle: { fontSize: 16, fontWeight: '700', color: '#1A1A2E', marginBottom: 12 },
  card: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#E8C4B8' },
  cardSelected: { borderColor: '#2D6A4F', borderWidth: 2, backgroundColor: '#F0FDF4' },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 },
  cityName: { fontSize: 18, fontWeight: '800', color: '#1A1A2E' },
  stateName: { fontSize: 12, color: '#64748b' },
  badge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  badgeCrit: { backgroundColor: '#E63946' },
  badgeHigh: { backgroundColor: '#F4A261' },
  badgeText: { color: '#FFFFFF', fontSize: 10, fontWeight: '800' },
  row: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 6 },
  label: { fontSize: 13, color: '#64748b' },
  val: { fontSize: 13, fontWeight: '700', color: '#1A1A2E' },
  textDanger: { color: '#E63946' },
  textSafe: { color: '#2D6A4F' },
});
